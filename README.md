...
O núcleo técnico (20 capítulos) é uma **tradução integral para o português** da análise de engenharia reversa produzida por [zhu1090093659](https://github.com/zhu1090093659/claude-code-cookbook) (licença MIT), o trabalho mais completo de dissecação módulo por módulo do código-fonte. Cada capítulo credita o autor original. Sobre essa base traduzida, este projeto constrói camadas originais: cartografias interativas, análise de governança e dados estruturados.
...
|                    |Análise original (EN/ZH)      |Este projeto                             |
|--------------------|------------------------------|-----------------------------------------|
|**Idioma**          |Inglês e chinês               |**Português (ES planejado)**             |
|**Base técnica**    |20 capítulos por zhu1090093659|**Tradução integral + crédito**          |
...
|**Visualização**    |Texto                         |**Cartografia interativa navegável**     |
|**Produção**        |Claude Code                   |**Claude Code para analisar Claude Code**|
...
*Capítulos traduzidos de [claude-code-cookbook](https://github.com/zhu1090093659/claude-code-cookbook) por zhu1090093659 (Licença MIT). Tradução PT-BR e camada analítica: Ricardo Kaminski.*
...
- **[Cartografia C0](cartografia/c0-visao-geral.jsx)** — grafo interativo dos módulos com camada de governança (React artifact)
- **[Dados extraídos](dados)** — modulos.json (1.884 arquivos inventariados), tools.json (40+ ferramentas catalogadas)
- **[Site navegável](https://ricardo-kaminski.github.io/anatomia-agente-ia/)** — React + Vite no GitHub Pages

-----

## O que vem a seguir

Ver <ROADMAP.md> para o plano completo. Em desenvolvimento:
...
**Núcleo técnico:** Tradução integral de [claude-code-cookbook](https://github.com/zhu1090093659/claude-code-cookbook) por zhu1090093659 (Licença MIT)
**Camadas originais:** Cartografia C0, dados extraídos, análise de governança — Ricardo Kaminski
**Versão analisada:** Claude Code v2.1.88 (snapshot histórico de março de 2025)
**Método:** Inspirado na cartografia crítica de Vladan Joler e Kate Crawford (*Anatomy of an AI System*, 2018)
**Produção:** Claude Code para analisar o próprio Claude Code — recursividade metodológica documentada no processo.
